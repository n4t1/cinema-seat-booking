...
export class ProductionCompanyDTO
  implements
    IDeserialize<ProductionCompanyDTO, IProductionCompanyRest>,
    IProductionCompanyRest {
  public id: number;
...
export class ProductionCountryDTO
  implements
    IDeserialize<ProductionCountryDTO, IProductionCountryRest>,
    IProductionCountryRest {
...
export class SpokenLanguageDTO
  implements
    IDeserialize<SpokenLanguageDTO, ISpokenLanguageRest>,
    ISpokenLanguageRest {
...
export class MovieDetailsDTO
  implements
    IDeserialize<MovieDetailsDTO, IMovieDetailsRest>,
    IMovieDetailsRest {
